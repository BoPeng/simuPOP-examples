...
* Demonstration of a bottleneck effect [[http://simupop.sourceforge.net/wileyBook/ch3_bottleneck.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_bottleneck.log|`[log]`]]
* Number of ancestors of a diploid simulation [[http://simupop.sourceforge.net/wileyBook/ch3_diploidGenealogy.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_diploidGenealogy.log|`[log]`]]
* Number of ancestors of a haploid simulation [[http://simupop.sourceforge.net/wileyBook/ch3_haploidGenealogy.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_haploidGenealogy.log|`[log]`]]
* An island model of migration [[http://simupop.sourceforge.net/wileyBook/ch3_islands.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_islands.log|`[log]`]]
* K-allele and stepwise mutation models [[http://simupop.sourceforge.net/wileyBook/ch3_multiAllelicMutator.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_multiAllelicMutator.log|`[log]`]]
* Recombination between three loci [[http://simupop.sourceforge.net/wileyBook/ch3_recombination.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_recombination.log|`[log]`]]
* Single locus diallelic selection models [[http://simupop.sourceforge.net/wileyBook/ch3_selection.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_selection.log|`[log]`]]
* Diallelic mutation model [[http://simupop.sourceforge.net/wileyBook/ch3_snpMutator.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_snpMutator.log|`[log]`]]
...
* Simulating allele frequency trajectory forward in time. [[http://simupop.sourceforge.net/wileyBook/ch6_forwardTrajectory.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch6_forwardTrajectory.log|`[log]`]]
* Simulation of populations with realistic pattern of linkage disequilibrium [[http://simupop.sourceforge.net/wileyBook/ch6_simuGWAS.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch6_simuGWAS.log|`[log]`]]
* A single locus penetrance model of breast cancer [[http://simupop.sourceforge.net/wileyBook/ch3_pyPenetrance.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_pyPenetrance.log|`[log]`]]
* Draw case control samples [[http://simupop.sourceforge.net/wileyBook/ch6_caseCtrl.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch6_caseCtrl.log|`[log]`]]
* Using a controlled mating scheme with a backward-simulated trajectory [[http://simupop.sourceforge.net/wileyBook/ch6_controlledMating.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch6_controlledMating.log|`[log]`]]
* Generating affected sibpair samples [[http://simupop.sourceforge.net/wileyBook/ch6_genAffectedSibpairs.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch6_genAffectedSibpairs.log|`[log]`]]
...
* A quantitative trait model [[http://simupop.sourceforge.net/wileyBook/ch3_qtrait.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch3_qtrait.log|`[log]`]]
* Example of the evolution of age-structured population. [[http://simupop.sourceforge.net/wileyBook/ch7_ageStructured.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_ageStructured.log|`[log]`]]
* An example of assortative mating [[http://simupop.sourceforge.net/wileyBook/ch7_assortativeMating.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_assortativeMating.log|`[log]`]]
* Use a hetergeneous mating scheme to simulate partial self-fertilization [[http://simupop.sourceforge.net/wileyBook/ch7_heteroMating.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_heteroMating.log|`[log]`]]
* Simulation of mating behaviors of pilot whales [[http://simupop.sourceforge.net/wileyBook/ch7_PyParentsChooser.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_PyParentsChooser.log|`[log]`]]
* A sequential selfing mating scheme [[http://simupop.sourceforge.net/wileyBook/ch7_sequentialSelfing.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_sequentialSelfing.log|`[log]`]]
* A mating scheme with continuous habitat [[http://simupop.sourceforge.net/wileyBook/ch7_vicinityMating.py|`[source]`]] [[http://simupop.sourceforge.net/wileyBook/ch7_vicinityMating.log|`[log]`]]
